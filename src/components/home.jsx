...
//         <div className="mt-auto md:mt-0">
//           <p className="text-4xl text-gray-400">Hi, I am</p>
//           <h1 className="font-bold text-6xl gradient-text-animation">
//             Javad Ali
//           </h1>
//           <h2 className="font-bold text-6xl mb-4 gradient-text-animation">
//             MERN Stack Developer
//           </h2>
//           <p className="mb-4 max-w-[725px] text-gray-400">
...
//               className="mr-4 hover:text-gray-400 text-white"
//             >
//               <FontAwesomeIcon icon={faLinkedin} size="2x" />
//             </a>
//             <a
